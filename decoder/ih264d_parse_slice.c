                                 ...
                                 )
{
    ...
    /*
     * Restore the old PB-skip picture-boundary state machine.  Unlike the
     * surviving u4_skip_frm_mask check later in this function, this logic
     * makes sure a run of skipped P/B NALs ends cleanly before the next
     * picture is handed back to the application.
     */
       ...
       (ps_dec->i4_dec_skip_mode == IVD_SKIP_PB))
    {
        ...
        /*
         * If this is the first slice of a new picture after NALs were
         * skipped, stop here and return the boundary to the application.
         */
        ...
        else if(1 == ps_dec->u4_prev_nal_skipped)
        {
